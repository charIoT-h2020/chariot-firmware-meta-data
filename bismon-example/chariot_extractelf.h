...
extern "C"
{
  ...
  typedef enum
  {
    CMS_Mainboot_sha256, CMS_Format_typeinfo, CMS_Mainboot_offsetnum,
    CMS_Mainboot_sizesnum,
    CMS_Extraboot_sha256, CMS_Extraboot_offsetnum, CMS_Extraboot_sizenum,
    CMS_Extraboot_typeinfo,
    CMS_Codanalys_typeinfo, CMS_Version_data, CMS_Firmware_path,
    CMS_Firmware_license,
  ...
  int fill_exe_header (Elf32_Ehdr * result, const char *buffer_exe,
		       size_t buffer_len, const char **error_message);
  int retrieve_section_header (Elf32_Shdr * section_header,
			       const Elf32_Ehdr * elf_header,
			       const char *buffer_exe, size_t buffer_len,
			       Chariot_Section section,
  ...
  int fill_metadata_dict (Chariot_Metadata_localizations *
			  chariot_metadata_localizations,
			  const char **error_message);
